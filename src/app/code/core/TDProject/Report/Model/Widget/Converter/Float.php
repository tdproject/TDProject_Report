...
/**
 * TDProject_Report_Model_Widget_Converter_Float
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Report_Model_Widget_Converter_Float
    implements TDProject_Report_Model_Widget_Interfaces_Converter
{
    ...
    /**
     * Sets the passed value converted in an float that represents 
    	...
    	TDProject_Report_Model_Widget_Interfaces_ReportField $reportField)
    {
    	...
    	// create an Float representation
    	$value = new TechDivision_Lang_Float(floatval($reportField->getValue($oldKey)));
        // and return it
